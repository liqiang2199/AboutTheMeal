...
//    public static String URL = "http://47.93.231.42";
    ...
    public static String Uploadheader = "/Uploadheader";
    public static String changephone = "/changephone";//更换手机号
    ...
    public static String createOrder = "/createOrder";//创建订单
    public static String getOrderList = "/getOrderList";//获取订单
    public static String payOrder = "/payOrder";//支付订单
}
